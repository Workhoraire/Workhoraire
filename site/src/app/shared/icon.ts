...
const ICONS = {
  ...
  download: ['M14 3H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8z', 'M14 3v5h5', 'M12 11v6', 'M9 14l3 3 3-3'],
  link: [
    'M10 14a4 4 0 0 0 5.7 0l3-3a4 4 0 0 0-5.7-5.7l-1 1',
    'M14 10a4 4 0 0 0-5.7 0l-3 3a4 4 0 0 0 5.7 5.7l1-1',
  ],
  user: ['M12 12a4 4 0 1 0 0-8a4 4 0 1 0 0 8z', 'M4.5 21a7.5 7.5 0 0 1 15 0'],
  users: [
  ...
  shield: ['M12 3 5 6v5.5c0 4.4 3 8.1 7 9.5c4-1.4 7-5.1 7-9.5V6z', 'M9 12l2 2 4-4'],
  eyeOff: [
    'M3 3l18 18',
